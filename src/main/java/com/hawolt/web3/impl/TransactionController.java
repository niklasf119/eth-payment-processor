...
public class TransactionController extends AbstractController<IAddressListener, Transaction, Flowable<Transaction>> {

    public TransactionController(Flowable<Transaction> flowable) {
        super(flowable);
    }
